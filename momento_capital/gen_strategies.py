...
def gen_dinorah(
    ...
    return dinorah(
        ...
        portfolio_id=portfolio_id,
        freq=int(gen[0]),
        etfs_rsi_window_size=int(gen[1]),
        etfs_rsi_lower_limit=int(gen[2]),
        etfs_rsi_upper_limit=int(gen[3]),
        etfs_sma_window_size_1=int(gen[4]),
        etfs_sma_window_size_2=int(gen[5]),
        holdings_sma_window_size=int(gen[6]),
        holdings_rm_window_size=int(gen[7]),
        holdings_rm_n_top=int(gen[8]),
        bb_window_size=int(gen[9]),
        bb_factor=float(gen[10]),
    )
